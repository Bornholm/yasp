  ...
  render() {
    ...
    let cards = apps.map(app => {
      ...
      let toggleApp = app.isRunning ?
        this.stopApp.bind(this, app.id) :
        this.startApp.bind(this, app.id)
      ;
      ...
      return (
        ...
        <Panel key={app.instanceId} header={header} style={cardStyle} footer={footer}>
          <form className="form-horizontal">
            ...
            <FormControls.Static label="Date de création" labelClassName="col-xs-3" wrapperClassName="col-xs-9" value={app.creationDate} />
          </form>
        </Panel>
        /* jshint ignore:end */
      );
