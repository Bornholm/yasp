...
class InstanciateView extends React.Component {
  ...
  render() {
    ...
    if(hasVars) {
      ...
      varsConfig = (
        <div className="alert alert-info">{t('no_vars')}</div>
      );
    }
          ...
          <div className="panel panel-default">
            <div className="panel-heading" role="tab" id="customParamsHeading">
              <h4 className="panel-title">
                ...
                {t('configuration')}<i className="fa fa-pencil-square-o inline-icon"></i>
                </a>
              </h4>
            </div>
          ...
          <div className="panel panel-default">
            <div className="panel-heading" role="tab" id="portsMapperHeading">
              <h4 className="panel-title">
                ...
                {t('network')}<i className="fa fa-server inline-icon"></i>
                </a>
              </h4>
            </div>
